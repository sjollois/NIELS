...
class QuestionsMairie extends React.Component {
              ...
              {emptyRows > 0 && (
                ...
                .map(n => {
                  return (
                    <TableRow>
                      <TableCell>
                      <Link to={`/Video/Administratif/Mairie/${n.path}`} style={{ textDecoration: 'none' }}>
                      {n.path}
                      </Link>
                      </TableCell>
                    </TableRow>
...
QuestionsMairie.propTypes = {
  classes: PropTypes.object.isRequired,
  location: PropTypes.object.isRequired
};

export default compose(withStyles(styles),withRouter)(QuestionsMairie);
